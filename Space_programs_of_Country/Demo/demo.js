document.addEventListener('DOMContentLoaded', () => {
    ...
    const futurePlans = [
      { title: 'Future Plan 1', text: 'Details about Future Plan 1', link: 'future1.html', img: 'images/future-plan1.jfif' },
      { title: 'Future Plan 2', text: 'Details about Future Plan 2', link: 'future2.html', img: 'images/future-plan2.jfif' },
      { title: 'Future Plan 3', text: 'Details about Future Plan 3', link: 'future3.html', img: 'images/future-plan3.jfif' },
      { title: 'Future Plan 4', text: 'Details about Future Plan 4', link: 'future4.html', img: 'images/future-plan4.jfif' },
      { title: 'Future Plan 5', text: 'Details about Future Plan 5', link: 'future5.html', img: 'images/future-plan5.jfif' },
      { title: 'Future Plan 6', text: 'Details about Future Plan 6', link: 'future6.html', img: 'images/future-plan6.jfif' }
    ];
